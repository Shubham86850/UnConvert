...
import com.example.unconvert.ui.theme.UnConvertTheme
...
fun UnConvert (
    ...
    Column (
        ...
        OutlinedTextField(inputValue, onValueChange = {inputValue = it
                                                      convertUnits()},
...
@Composable
fun UnConvertPreview () {
    UnConvert(innerPadding = PaddingValues(8.dp))
}
